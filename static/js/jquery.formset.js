...
; (function ($) {
    $.fn.formset = function (opts) {
        var options = $.extend({}, $.fn.formset.defaults, opts),
            ...
            reset_options_fields = function (row) {
                $.each(row.find('select'), function (index, val) {
        ...
        if ($$.length) {
            ...
            if (options.addContainerClass) {
                ...
                var numCols = $$.eq(0).children().length,   // This is a bit of an assumption :|
                    buttonRow = $('<tr><td colspan="' + numCols + '">' + addButtonHTML + '</tr>').addClass(options.formCssClass + '-add text-right ');
            ...
            addButton.click(function () {
                ...
                for(let i = 0; i <= 1; i++ ) {
                    $('.dateinput').daterangepicker({
                        ...
                        // startDate: $("#initial_calendar_date").val(),
    ...
    $.fn.formset.defaults = {
        ...
        preadd: null,                     // Function called each time a new form is added
